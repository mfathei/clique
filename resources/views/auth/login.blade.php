...
<link href="{{ url('admin/assets/admin/pages/css/login.css') }}" rel="stylesheet" type="text/css"/>
...
<link href="{{ url('admin/assets/admin/layout4/css/themes/default.css') }}" rel="stylesheet" type="text/css" id="style_color"/>
...
<div class="logo">
	<a href="{{ route('/') }}">
	<img src="{{ url('/images/logo.png') }}" alt="" style="max-height: 150px;"/>
	</a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
